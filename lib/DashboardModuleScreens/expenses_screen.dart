...
class _ExpensesScreenState extends State<ExpensesScreen> {
  ...
  List<QueryDocumentSnapshot> filterByMonth(List<QueryDocumentSnapshot> docs, String monthYear) {
  ...
  Map<String, double> calculateCategoryTotals(List<QueryDocumentSnapshot> docs) {
  ...
  Widget _buildExpenseTile(String title, String category, String amount, String date) {
    return Card(
      elevation: 3,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: const [
            Text("Expenses", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            SizedBox(height: 2),
            Text(
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              const Text("Category-wise Expenses",
              ...
              ...filteredDocs.map((doc) {
                ...
                return _buildExpenseTile(
                    data['title'], data['category'], data['amount'].toString(), data['date'].toString());
              }).toList(),
            ],
          );
        },
